...
public final class HighlightingSettingsImpl implements HighlightingSettings {

    private static final Logger LOGGER = LogManager.getLogger(HighlightingSettingsImpl.class);
    ...
    public HighlightingSettingsImpl(final @NotNull Preferences preferences) {
