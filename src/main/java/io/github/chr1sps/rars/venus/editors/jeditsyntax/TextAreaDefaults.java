...
public class TextAreaDefaults {
    ...
    public static TextAreaDefaults getDefaults() {
        ...
        DEFAULTS.caretBlinks = (io.github.chr1sps.rars.Globals.getSettings().getCaretBlinkRate() != 0);
        DEFAULTS.caretBlinkRate = io.github.chr1sps.rars.Globals.getSettings().getCaretBlinkRate();
        DEFAULTS.tabSize = io.github.chr1sps.rars.Globals.getSettings().getEditorTabSize();
        ...
        DEFAULTS.lineHighlight = io.github.chr1sps.rars.Globals.getSettings()
