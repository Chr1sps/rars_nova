...
public final class FontSettingsImpl implements FontSettings {
    private static final @NotNull Logger LOGGER = LogManager.getLogger(FontSettingsImpl.class);
    ...
    public FontSettingsImpl(final @NotNull Preferences preferences) {
