...
public final class EditorThemeSettingsImpl implements EditorThemeSettings {
    private static final @NotNull Logger LOGGER = LogManager.getLogger(EditorThemeSettingsImpl.class);
    /**
    ...
    public EditorThemeSettingsImpl(final @NotNull Preferences preferences) {
